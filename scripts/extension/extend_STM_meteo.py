...
def update_metadata(code, new_last_ts, new_count, non_zero_quality, total_rows):
    ...
    # Guard against re-running the script: skip note if already extended
    already_extended = any("Extensión con datos de precipitación y temperatura" in l for l in lines)
