...
#   1 = HEIGHT (filtered/validated), 14 = TEMPERATURE...14 (water temp), 15 = DATE.UTC
# Only HEIGHT_m and WATER_TEMP_C are extracted; other variables will be
# derived later from rating curves.
COL_HEIGHT = 1
COL_TEMP   = 14
COL_DATE   = 15
